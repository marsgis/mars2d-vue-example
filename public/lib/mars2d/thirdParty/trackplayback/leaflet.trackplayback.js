  ...
  return (function (t) {
    ...
    return (
      ...
      (e.t = function (t, i) {
        ...
        if ((e.r(s), Object.defineProperty(s, "default", { enumerable: !0, value: t }), 2 & i && "string" != typeof t))
          for (var n in t)
            e.d(
              s,
              n,
    ...
    function (t, i, e) {
      ...
      const a = n.a.Class.extend({
          ...
          addTrackPoint: function (t) {
            if (r(t)) for (let i = 0, e = t.length; i < e; i++) this.addTrackPoint(t[i])
        ...
        o = n.a.Class.extend({
          ...
          addTrack: function (t) {
            if (r(t)) for (let i = 0, e = t.length; i < e; i++) this.addTrack(t[i])
            else {
        ...
        h = n.a.Class.extend({
          ...
          setCursor: function (t) {
            ;(this._curTime = t), this._trackController.drawTracksByTime(this._curTime), this.fire("tick", { time: this._curTime })
          },
          setSpeed: function (t) {
        ...
        c = n.a.Renderer.extend({
          initialize: function (t) {
            n.a.Renderer.prototype.initialize.call(this, t), (this.options.padding = 0.1)
          },
          onAdd: function (t) {
        ...
        l = n.a.Class.extend({
          trackPointOptions: { isDraw: !1, useCanvas: !0, stroke: !1, color: "#ef0300", fill: !0, fillColor: "#ef0300", opacity: 0.3, radius: 4 },
          trackLineOptions: { isDraw: !1, stroke: !0, color: "#1C54E2", weight: 2, fill: !1, fillColor: "#000", opacity: 0.3 },
          targetOptions: {
            useImg: !1,
          ...
          remove: function () {
            ;(this._bufferTracks = []),
              ...
              this._trackPointFeatureGroup && this._map.removeLayer(this._trackPointFeatureGroup)
          },
          clear: function () {
          ...
          _onmousemoveEvt: function (t) {
            ...
            this._tooltip && this._map.hasLayer(this._tooltip) && this._map.removeLayer(this._tooltip), (this._canvas.style.cursor = "pointer")
          },
          _opentoolTip: function (t) {
            this._tooltip && this._map.hasLayer(this._tooltip) && this._map.removeLayer(this._tooltip), (this._canvas.style.cursor = "default")
          ...
          _drawTrackLine: function (t) {
            ...
            ;(this._ctx.globalAlpha = i.opacity),
              i.stroke && ((this._ctx.strokeStyle = i.color), (this._ctx.lineWidth = i.weight), this._ctx.stroke()),
            ...
            for (let e = 0, s = t.length; e < s; e++)
              if (t[e].isOrigin) {
                ...
                this._ctx.beginPath(),
                  ...
                  (this._ctx.globalAlpha = i.opacity),
                  i.stroke && ((this._ctx.strokeStyle = i.color), this._ctx.stroke()),
                  i.fill && ((this._ctx.fillStyle = i.fillColor), this._ctx.fill())
              }
            this._ctx.restore()
          },
          ...
          _getTooltipText: function (t) {
            ...
            if ((i.push("<table>"), t.info && t.info.length))
              for (let e = 0, s = t.info.length; e < s; e++)
                i.push("<tr>"), i.push("<td>" + t.info[e].key + "</td>"), i.push("<td>" + t.info[e].value + "</td>"), i.push("</tr>")
          ...
          _clearLayer: function () {
            ...
            this._trackPointFeatureGroup && this._trackPointFeatureGroup.clearLayers()
          },
          _getLayerPoint(t) {
        ...
        _ = n.a.Class.extend({
          ...
          _initTracks: function (t) {
            let i = []
            if (r(t))
              if (r(t[0])) for (let e = 0, s = t.length; e < s; e++) i.push(new a(t[e]))
              else i.push(new a(t))
            return i
          }
        })
