(function (global, factory) {
  ...
  const WindLayer = L__namespace.Layer.extend({
    options: {},
    ...
    _createCanvas(id, zIndex) {
      const layer = L__namespace.DomUtil.create("div", "leaflet-canvas-layer");
