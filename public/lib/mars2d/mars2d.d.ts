...
declare module "mars2d" {
   ...
   */
    ...
    export class MapSwich extends leaflet.Control {
         ...
         * @returns 无
         */
        on(types: string | EventType, fn: any, context: any): void;
        /**
         * 解除绑定指定类型事件监听器
         * @param types - 事件类型
         * @param fn - 绑定的监听器回调方法
         ...
         * @returns 无
         */
        off(types: string | EventType, fn: any, context: any): void;
        /**
         * 触发指定类型的事件。
         * @param type - 事件类型
         ...
         * @returns 无
         */
        once(types: string | EventType, fn: any, context: any): void;
        /**
         * 是否有绑定指定的事件
         * @param type - 事件类型
     ...
     * 一般在页面下侧区域
     * @param options - 参数对象，包括以下：
     * @param [options.position = "bottomright"] - 控件的位置
    ...
    export class BaseClass {
         ...
         * @returns 当前对象本身,可以链式调用
         */
        on(types: EventType | EventType[], fn: any, context: any): BaseClass;
        /**
         * 解除绑定指定类型事件监听器
         * @param types - 事件类型
         * @param fn - 绑定的监听器回调方法
         ...
         * @returns 当前对象本身,可以链式调用
         */
        off(types: EventType | EventType[], fn: any, context: any): BaseClass;
        /**
         * 触发指定类型的事件。
         * @param type - 事件类型
         * @param data - 传输的数据或对象，可在事件回调方法中event对象中获取进行使用
         ...
         * @returns 当前对象本身,可以链式调用
         */
        once(types: EventType | EventType[], fn: any, context: any): BaseClass;
        /**
         * 添加抛出事件到父类，它将接收传播的事件
         * @param obj - 父类对象
         * @returns 当前对象本身,可以链式调用
    ...
    export class CanvasImage extends leaflet.Path {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        bindPopup(content: string | HTMLElement | any, options?: Map.PopupOptions): any;
        /**
         * 解除绑定Popup弹窗配置
         * @returns 当前对象本身，可以链式调用
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        openPopup(latlng?: leaflet.LatLng): any;
        /**
         * 关闭打开的弹窗
         * @returns 当前对象本身，可以链式调用
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setPopupContent(content: string | HTMLElement | leaflet.Popup): any;
        /**
         ...
         * @returns 当前对象本身，可以链式调用
         */
        bindTooltip(content: string | HTMLElement | any, options?: any): any;
        /**
         * 解除绑定Tooltip弹窗配置
         * @returns 当前对象本身，可以链式调用
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        openTooltip(latlng?: leaflet.LatLng): any;
        /**
         * 关闭打开的弹窗
         * @returns 当前对象本身，可以链式调用
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setTooltipContent(content: string | HTMLElement | leaflet.Tooltip): any;
        /**
    ...
    export class Circle extends leaflet.Circle {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setLatLng(latlng: leaflet.LatLng): any;
        /**
         * 获取圆的矩形边界
         * @returns 矩形边界
         */
    ...
    export namespace Image {
         ...
         * @property [interactive = true] - 是否触发鼠标事件，如果false，该层不会发出鼠标事件，并且将作为底层地图的一部分。
         * @param url - 图片url地址
         * @param [opacity = 1] - 瓦片的不透明度。
         * @param [crossOrigin = false] - 如果为true，则所有图块将其crossOrigin属性设置为“*”。如果要访问像素数据，则需要这样做。
         */
        type StyleOptions = {
            interactive?: boolean;
        };
    ...
    export class Marker extends leaflet.Marker {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setZIndexOffset(offset: number): any;
        /**
         * 改变透明度
         * @param opacity - 透明度
         * @returns 当前对象本身，可以链式调用
    ...
    export class Point extends leaflet.CircleMarker {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setStyle(newStyle: Point.StyleOptions): any;
        /**
         * 将图层数据导出为GeoJSON格式规范对象。
         * @param [options] - 参数对象:
         * @param [options.precision] - 保留经纬度的小数位数
    ...
    export class Polygon extends leaflet.Polygon {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setLatLngs(latlngs: leaflet.LatLng[]): any;
        /**
         * 向矢量对象添加一个给定点。
         * @param latlng - 经纬度对象
         * @returns 当前对象本身，可以链式调用
         */
        addLatLng(latlng: leaflet.LatLng): any;
        /**
         * 获取线的矩形边界
         * @returns 矩形边界
         */
    ...
    export class Rectangle extends leaflet.Rectangle {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setBounds(latLngBounds: leaflet.LatLngBounds): any;
        /**
         * 返回矢量对象的坐标点的数组，或者在多矢量对象的情况下返回嵌套的点阵列。
         * @returns 经纬度数组
         */
    ...
    export class CanvasMarkerLayer extends leaflet.Layer {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        addOnClickListener(listener: any): CanvasMarkerLayer;
        /**
         * 增加绑定鼠标移入事件
         * @param listener - 事件方法
         * @returns 当前对象本身，可以链式调用
         */
        addOnHoverListener(listener: any): CanvasMarkerLayer;
    }
    ...
    export class ClusterLayer extends leaflet.Layer {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        zoomToShowLayer(marker: Marker, callback: any): ClusterLayer;
        /**
         * 将图层置于所有图层之上
         * @returns 当前对象本身,可以链式调用
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        addGraphic(graphic: Marker): any;
        /**
         * 移除指定矢量对象
         * @param graphic - 指定矢量对象
         * @returns 当前对象本身，可以链式调用
         */
        removeGraphic(graphic: Marker): any;
        /**
         * 是否包含Graphic矢量数据
         * @param graphic - 矢量数据
         * @returns 是否包含
         ...
         * @returns 当前对象本身,可以链式调用
         */
        eachGraphic(method: any, context: any): any;
        /**
         * 清除图层内所有矢量数据
         * @returns 无
         */
    ...
    export class GraphicLayer extends leaflet.FeatureGroup {
         ...
         * @returns 当前对象本身,可以链式调用
         */
        eachGraphic(method: any, context: any): GraphicLayer;
        /**
         * 获取图层内 所有矢量数据
         * @returns 矢量数据数组
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        openPopup(graphic: Marker | Polyline | Polygon | any): any;
        /**
         * 执行平滑的飞行动画，移动缩放地图范围至指定的数据范围
         * @param [options] - 定位参数，包括:
         * @param [options.paddingTopLeft] - 设置在将视图设置为适合边界时不应考虑的地图容器左上角的填充量。如果您在地图上有一些控件重叠式（如侧边栏），而且您不希望它们遮挡您正在缩放的对象，则很有用。
    ...
    export class WfsLayer extends VirtualGrid {
         ...
         * @returns 当前对象本身,可以链式调用
         */
        eachGraphic(method: any, context: any): WfsLayer;
        /**
         * 清除图层内所有矢量数据
         * @returns 无
         */
    ...
    export class GroupLayer extends leaflet.LayerGroup {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        addLayer(childlayer: leaflet.Layer): any;
        /**
         * 移除图层
         * @param childlayer - 移除的子图层 或 图层ID
         * @returns 当前对象本身，可以链式调用
         */
        removeLayer(childlayer: leaflet.Layer | number): any;
        /**
         * 定位地图至当前图层数据区域
         * @param [options] - 定位参数，包括:
         * @param [options.paddingTopLeft] - 设置在将视图设置为适合边界时不应考虑的地图容器左上角的填充量。如果您在地图上有一些控件重叠式（如侧边栏），而且您不希望它们遮挡您正在缩放的对象，则很有用。
    ...
    export class ImageLayer extends leaflet.ImageOverlay {
         ...
         * @returns 当前对象本身,可以链式调用
         */
        setBounds(bounds: leaflet.LatLngBounds): any;
        /**
         * 获取图层矩形边界
         * @returns 矩形边界
         */
    ...
    export class TileLayer extends leaflet.TileLayer {
         ...
         * @returns 无
         */
        setCustomColor(customColor: any): void;
        /**
         * 销毁当前对象
         * @param [noDel = false] - false:会自动delete释放所有属性，true：不delete绑定的变量
         * @returns 无
    ...
    export class WmsLayer extends leaflet.TileLayer.WMS {
         ...
         * @returns 当前对象本身,可以链式调用
         */
        setParams(params: any, noRedraw?: boolean): any;
        /**
         * 将图层置于所有图层之上
         * @returns 当前对象本身,可以链式调用
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        bindPopup(fn: string | any | any, popupOptions?: Map.PopupOptions): any;
        /**
         * 解除绑定Popup弹窗配置
         * @returns 当前对象本身，可以链式调用
         */
    ...
    export class Map extends leaflet.Map {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        addLayer(layer: leaflet.Layer, addToControl?: boolean): any;
        /**
         * 从地图上移除一个指定的图层
         * @param layer - 图层
         ...
         * @returns 当前对象本身，可以链式调用
         */
        removeLayer(layer: leaflet.Layer, removeFromControl?: boolean): any;
        /**
         * 获取图层ID值，按顺序取值。
         ...
         * @returns 当前对象本身，可以链式调用
         */
        bindContextMenu(arr: any): any;
        /**
         * 取消绑定右键菜单
         * @returns 当前对象本身，可以链式调用
         */
        unbindContextMenu(): any;
        /**
         * 显示小提示窗，一般用于鼠标操作的提示。
         ...
         * @returns 当前对象本身，可以链式调用
         */
        openSmallTooltip(position: any, message: any): any;
        /**
         * 关闭小提示窗
         * @returns 当前对象本身，可以链式调用
         */
        closeSmallTooltip(): any;
        /**
         * 判断是否已经全屏
         * @returns 是否已经全屏
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        removeThing(item: BaseThing, hasDestroy: boolean): any;
        /**
         ...
         * @returns 当前对象本身,可以链式调用
         */
        eachThing(method: any, context: any): any;
        /**
         * 根据指定属性获取Thing对象
         ...
         * @returns 当前对象本身，可以链式调用
         */
        addControl(control: leaflet.Control): any;
        /**
         * 从地图上移除一个指定的控件
         * @param control - 控件
         * @returns 当前对象本身，可以链式调用
         */
        removeControl(control: leaflet.Control): any;
        /**
         * 遍历地图的图层
         * @param method - 回调方法
         * @param [context] - 侦听器的上下文(this关键字将指向的对象)。
         ...
         * @returns 当前对象本身，可以链式调用
         */
        closePopup(popup?: leaflet.Popup): any;
         ...
         * @returns 当前对象本身，可以链式调用
         */
        closeTooltip(tooltip?: leaflet.Tooltip): any;
        /**
         * 定位地图至指定位置和层级
         * @param center - 经纬度坐标
         ...
         * @returns 当前对象本身，可以链式调用
         */
        panBy(offset: leaflet.Point): any;
        /**
         * 限制地图的视图在给定的边界里面 (参考 地图的 maxBounds 参数选项)
         * @param bounds - 最大边界
         * @returns 当前对象本身，可以链式调用
         */
        setMaxBounds(bounds: leaflet.LatLngBounds): any;
        /**
         * 设置地图最小缩放级别 (参考 minZoom 参数选项)
         * @param zoom - 最小缩放级别
         * @returns 当前对象本身，可以链式调用
         */
        setMinZoom(zoom: number): any;
        /**
         * 设置地图最大缩放级别 (参考 maxZoom 参数选项)
         * @param zoom - 最大缩放级别
         * @returns 当前对象本身，可以链式调用
         */
        setMaxZoom(zoom: number): any;
        /**
         ...
         * @returns 距离，单位：米
         */
        distance(latlng1: leaflet.LatLng, latlng2: leaflet.LatLng): any;
        /**
         ...
         * @returns 像素坐标， 相对于地图container容器
         */
        latLngToContainerPoint(latlng: leaflet.LatLng): any;
        /**
         * 给定一个MouseEvent对象，返回相对于发生事件的地图容器的像素坐标（与地图左上角相关）。
         * @param event - MouseEvent对象
         * @returns 像素坐标，相对于地图container容器
         */
        mouseEventToContainerPoint(event: any): any;
        /**
         * 给定一个MouseEvent对象，返回相对于事件发生的[origin pixel]{@link Map#getPixelOrigin}的像素坐标。
         * @param event - MouseEvent对象
         * @returns 像素坐标，相对于地图container容器
         */
        mouseEventToLayerPoint(event: any): any;
        /**
         * 给定一个MouseEvent对象，返回发生事件的地理坐标。
         * @param event - MouseEvent对象
         * @returns 地理坐标
         */
        mouseEventToLatLng(event: any): leaflet.LatLng;
        /**
         ...
         * @returns 当前对象本身，可以链式调用
         */
        addHandler(name: string, handler: any): any;
        /**
         ...
         * @returns 当前对象本身，可以链式调用
         */
        whenReady(fn: any, context?: any): any;
    ...
    export class ArcGisDynamicLayer extends leaflet.TileLayer {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        bindPopup(content: any, options?: Map.PopupOptions): any;
        /**
         * 解除绑定Popup弹窗配置
         * @returns 当前对象本身，可以链式调用
         */
         ...
         * @returns 当前对象本身，可以链式调用
         */
        metadata(callback: any, context?: any): ArcGisDynamicLayer;
        /**
         ...
         */
        identify(callback: any, context?: any): any;
        /**
         ...
         */
        find(callback: any, context?: any): any;
        /**
         ...
         */
        query(callback: any, context?: any): any;
        /**
         * 用于向服务发出新请求并绘制响应。
         * @returns 当前对象本身，可以链式调用
         */
    ...
    export class ArcGisFeatureLayer extends leaflet.Layer {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        setWhere(where: string, callback?: any, context?: any): ArcGisFeatureLayer;
        /**
         * 请求有关此要素图层的元数据。将使用error和调用回调metadata。
         * @example
         ...
         * @returns 当前对象本身，可以链式调用
         */
        metadata(callback: any, context?: any): ArcGisFeatureLayer;
        /**
         * 返回leaflet.esri.Query可用于查询此服务的新对象。
         * @example
         * featureLayer.query()
         ...
         * @returns 当前对象本身，可以链式调用
         */
        addFeature(feature: any, callback?: any, context?: any): ArcGisFeatureLayer;
        /**
         ...
         * @returns 当前对象本身，可以链式调用
         */
        updateFeature(feature: any, callback?: any, context?: any): ArcGisFeatureLayer;
        /**
         ...
         * @returns 当前对象本身，可以链式调用
         */
        deleteFeature(id: string | number, callback?: any, context?: any): ArcGisFeatureLayer;
        /**
         ...
         * @returns 当前对象本身，可以链式调用
         */
        deleteFeatures(ids: string[] | number[], callback?: any, context?: any): ArcGisFeatureLayer;
        /**
         * 内置唯一标识ID
         */
        readonly uuid: string;
    ...
    export class ArcGisImageLayer extends leaflet.TileLayer {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        metadata(callback: any, context?: any): ArcGisImageLayer;
        /**
         * 返回leaflet.esri.Query可用于查询此服务的新对象。
         * @example
         * imageService.query()
    ...
    export class ArcGisTileLayer extends leaflet.TileLayer {
         ...
         * @returns 当前对象本身，可以链式调用
         */
        metadata(callback: any, context?: any): ArcGisTileLayer;
        /**
         * 返回一个IdentifyFeatures新对象，可用于识别该图层上的要素。您的回调函数将传递一个带有结果或错误的GeoJSON。
         * @example
         * dynamicMapLayer.identify()
    ...
    export class BaseWidget extends BaseClass {
         ...
         */
        eachView(callback: any, index?: number): any;
        /**
         ...
         * @returns 无
         */
        getHtml(url: string, callback: any): void;
    }
    ...
    namespace widget {
         ...
         * @returns 无
         */
        function eachWidget(method: any): void;
        /**
         * 绑定类到当前对应js的widget中。
         ...
         * @returns 无
         */
        function on(types: WidgetEventType | WidgetEventType[], fn: any, context: any): void;
        /**
         * 解除绑定指定类型事件监听器
         * @param types - 事件类型
         * @param fn - 绑定的监听器回调方法
         ...
         * @returns 无
         */
        function off(types: WidgetEventType | WidgetEventType[], fn: any, context: any): void;
        /**
         * 触发指定类型的事件。
         * @param type - 事件类型
         * @param data - 传输的数据或对象，可在事件回调方法中event对象中获取进行使用
         ...
         * @returns 无
         */
        function once(types: WidgetEventType | WidgetEventType[], fn: any, context: any): void;
        /**
         * 是否有绑定指定的事件
         * @param type - 事件类型
         * @param [propagate = null] - 是否判断指定的父类 (用addEventParent设置的)
    ...
    namespace PointUtil {
         ...
         */
        function getTransFun(srcCoordType: ChinaCRS, dstCoordType: ChinaCRS): any;
        /**
         * 克隆坐标数组
         * @param latlngs - 坐标数组
         * @returns 新的坐标数组
